...
from SegEarthR1.constants import IGNORE_INDEX, IMAGE_TOKEN_INDEX, DEFAULT_IMAGE_TOKEN, DEFAULT_IM_START_TOKEN, \
    DEFAULT_IM_END_TOKEN, DEFAULT_SEG_TOKEN, SEG_TOKEN_INDEX ,ANSWER_TOKEN_INDEX
from SegEarthR1.model.builder import load_pretrained_model
from SegEarthR1.utils import disable_torch_init
from SegEarthR1.mm_utils import get_model_name_from_path
from SegEarthR1 import conversation as conversation_lib
...
class DataArguments:
    ...
    mask_config: Optional[str] = field(default="./SegEarthR1/mask_config/maskformer2_swin_large.yaml")
    image_aspect_ratio: str = 'square'
    image_grid_pinpoints: Optional[str] = field(default=None)
    model_map_name: str = 'SegEarthR1'
