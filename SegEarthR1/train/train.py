...
from SegEarthR1.mask_config.config import Config
    ...
    for name, module in model.named_modules():
        ...
        for p in module.parameters():
            if p.requires_grad == True:
                ...
                print_flag = True
                break
def get_mask_config(config='./SegEarthR1/mask_config/maskformer2_swin_base_384_bs16_50ep.yaml'):
...
class ModelArguments:
    ...
    mask_config: Optional[str] = field(default="./SegEarthR1/mask_config/maskformer2_swin_base_384_bs16_50ep.yaml")
...
def train():
    ...
    print('using model SegEarthR1')
    model = SegEarthR1.from_pretrained(      # 加载模型
    ...
    if not model.is_train_mask_decode:
        mask2former_ckpt = model_args.vision_tower if model_args.load_mask2former else None # model_args.vision_tower: /data1/lky/proj/PSALM/pre_trained/Swin_base
