...
from segearth_r1.model.mask_decoder.Mask2Former_Simplify.utils.misc import is_dist_avail_and_initialized, \
    nested_tensor_from_tensor_list, get_world_size
from segearth_r1.model.mask_decoder.Mask2Former_Simplify.utils.point_features import point_sample, \
    get_uncertain_point_coords_with_randomness
from segearth_r1.model.mask_decoder.Mask2Former_Simplify.utils.matcher import HungarianMatcher, batch_dice_loss_jit, \
    batch_sigmoid_ce_loss_jit, batch_sigmoid_focal_loss
from segearth_r1.model.mask_decoder.Mask2Former_Simplify.utils.criterion import SetCriterion
...
class segearth_r1_criterion(nn.Module):
    ...
    def loss_masks(self, outputs, targets, indices, num_masks):
        ...
        src_masks = src_masks[src_idx] # [batch_size, 256, 256]
